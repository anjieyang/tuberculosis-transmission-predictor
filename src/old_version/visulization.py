...
import k_means
from cluster_out import get_clusters_kmeans, get_cluster_by_id
from cluster_out import find_adjacency
...
def coloring(cluster, annotator, color, size):
    ...
    for building in cluster.buildings:
        ...
        annotator.add_annotation(
            ...
            location=Location(x1=x1, y1=y1, x2=x2, y2=y2, page=0),
            appearance=Appearance(content=str(cluster.id), fill=(1, 1, 1), font_size=5),
        )  # black text
